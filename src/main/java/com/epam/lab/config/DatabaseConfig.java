...
public class DatabaseConfig {
    ...
    private static void createTables() throws SQLException {
        ...
        try {
            ...
            stmt.execute("INSERT INTO STUDENTS(id, first_name, last_name, login, password) VALUES (1, 'Andrew', 'Ivanov', 'student@epam.com', '$2a$12$Jc8iGMcdypf7gu9d4FW7uuZawX/mtYY/91bG1qHMUf7vua7ValDZ.')");//11111
            ...
            stmt.execute("INSERT INTO TEACHERS(id, first_name, last_name, login, password) VALUES (1, 'Roman', 'Fyodorov', 'teacher@epam.com', '$2a$12$Jc8iGMcdypf7gu9d4FW7uuZawX/mtYY/91bG1qHMUf7vua7ValDZ.')");
